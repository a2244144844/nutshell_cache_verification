...
> 本文描述 Cache 的替换选择策略：invalid way 优先，其次使用 LFSR victim；同时覆盖 clean eviction 与 dirty eviction 的行为。结构说明参考主规格 [Cache 规格说明文档](/Users/zzy/Workspace/ucagent/competition/track1_nutshell_cache/genspec_workspace/unity_test/Cache_spec.md)。
