...
- **Covered Functional Coverage Points**: 91/91 (100%)
- **Covered Bins**: 98/98 (100%)

The Toffee summary above is the authoritative functional-coverage closure metric. The per-bin tables below are the legacy random-collector view for the default seed/step sample (`seed=7`, `steps=18`); entries marked `gap` there do not imply an uncovered Toffee bin when the Toffee summary is 100%.
