...
| 路径 | 用途 |
| --- | --- |
| `/Users/zzy/Workspace/ucagent/competition/genspec_cache.yaml` | GenSpec 根目录配置副本。 |
| `/Users/zzy/Workspace/ucagent/competition/unity_test/Cache_spec.md` | RTL 分析生成的 Cache 主规范。 |
| `/Users/zzy/Workspace/ucagent/competition/unity_test/Cache/` | CacheStage1/2/3、MetaDataArray、DataArray、Replacement 子规范目录。 |
| `/Users/zzy/Workspace/ucagent/competition/unity_test/Cache_spec_summary.md` | human_check 阶段生成的人工审查摘要。 |
| `/Users/zzy/Workspace/ucagent/competition/unity_test/Cache_functions_and_checks.md` | GenSpec 对齐的 FG/FC/CK 矩阵。 |
| `/Users/zzy/Workspace/ucagent/competition/unity_test/Cache_line_func_map.md` | CK 到 `Cache.v` 行号的映射。 |
| `/Users/zzy/Workspace/ucagent/competition/unity_test/Cache_line_map_analysis.md` | 行映射审查说明。 |
| `/Users/zzy/Workspace/ucagent/competition/unity_test/tests/Cache_api.py` | 对现有 `CacheEnv` 的标准 API 薄包装。 |
| `/Users/zzy/Workspace/ucagent/competition/unity_test/tests/Cache_function_coverage_def.py` | 对现有 `CacheCoverage` 的标准覆盖率薄包装。 |
