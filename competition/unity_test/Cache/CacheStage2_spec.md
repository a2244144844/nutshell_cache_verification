...
> 本文描述 `CacheStage2` 的职责：在读出 meta/data 后完成命中判定、替换候选选择、forward 覆盖和 MMIO 位判断。结构说明参考主规格 [Cache 规格说明文档](/Users/zzy/Workspace/ucagent/competition/genspec_workspace/unity_test/Cache_spec.md)。
