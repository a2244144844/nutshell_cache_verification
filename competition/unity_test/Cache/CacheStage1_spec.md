...
> 本文描述 `CacheStage1` 的职责：接收上游请求、同时启动 meta/data 读查询，并把 set index / word index 传播给下一级。结构说明参考主规格 [Cache 规格说明文档](/Users/zzy/Workspace/ucagent/competition/genspec_workspace/unity_test/Cache_spec.md)。
