...
> 本文描述 Cache 的 metadata 存储阵列：4-way、128-set、21-bit 结构，包含 tag/valid/dirty 字段与 reset sweep 行为。结构说明参考主规格 [Cache 规格说明文档](/Users/zzy/Workspace/ucagent/competition/track1_nutshell_cache/genspec_workspace/unity_test/Cache_spec.md)。
