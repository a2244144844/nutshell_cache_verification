...
> 本文描述 Cache 的 data 存储阵列：4-way、1024-entry/way、64-bit word 组织，支持两读一写的使用模式。结构说明参考主规格 [Cache 规格说明文档](/Users/zzy/Workspace/ucagent/competition/track1_nutshell_cache/genspec_workspace/unity_test/Cache_spec.md)。
